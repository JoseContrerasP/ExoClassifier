...
import { BarChart3, LineChart, PieChart, TrendingUp, Key, CheckCircle2 } from "lucide-react";
...
const Visualize = () => {
  ...
  const handleSaveApiKey = () => {
    if (apiKey.trim()) {
      localStorage.setItem("visualize_api_key", apiKey);
    ...
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <Card className="mb-6">
        <CardHeader>
          ...
          <CardDescription>
            Enter your API key to fetch and visualize table data
          </CardDescription>
        </CardHeader>
        <CardContent>
